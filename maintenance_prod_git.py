...
async def maintenance_mode(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    message = (
        ...
        "Работает в бета-версии, но уже умеет искать фильмы и давать свои хвостатые мнения. "
        "Функций пока чуть меньше, чем в Telegram, но я активно учусь новым командам!\n\n"
